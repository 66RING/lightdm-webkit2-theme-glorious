class UsersScreen {
  constructor() {
    ...
    this._profilePictureContainer = document.querySelector(
  ...
  profilePictureContainerOnClickEvent() {
    this._profilePictureContainer.addEventListener("click", () => {
      // Rotate profile pic
  ...
  _userItemOnClickEvent(userProfile) {
    userProfile.item.addEventListener("click", () => {
  ...
  _updateProfileVariablesOnStartUp() {
    ...
    this._defaultUserDisplayName = this._localStorage.getItem(
      "defaultUserDisplayName"
    );
    this._defaultUserProfileImage = this._localStorage.getItem(
      "defaultUserProfileImage"
    );
    this._defaultUserProfileImageFallback = this._localStorage.getItem(
      "defaultUserProfileImageFallback"
    );
    ...
    if (this._defaultUserProfileImageFallback === null) {
      this._defaultUserProfileImageFallback = "assets/profiles/myUser.jpeg";
    }
  }
  ...
  _createUsersList() {
    ...
    for (let i = 0; i < this._usersObject.length; i++) {
      ...
      let userProfile = {
        ...
        profileImageFallBack: "assets/profiles/myUser.jpeg",
      };
